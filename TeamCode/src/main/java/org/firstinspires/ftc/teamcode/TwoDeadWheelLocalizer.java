...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 12092.878853170214; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 13896.835052298462; // x position of the perpendicular encoder (in tick units)
    }
